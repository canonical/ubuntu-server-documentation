...
> **Note**:
> If using MySQL or PostgreSQL as your database, you should already have the services available. Bacula will not install them for you. For more information, take a look at [MySQL databases](install-and-configure-a-mysql-server.md) and [PostgreSQL databases](install-and-configure-postgresql.md).
