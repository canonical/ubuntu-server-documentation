...
> **Note**:
> See these additional guides for details on setting up [Apache](../explanation/introduction-to-web-servers.md), [Domain Name Service (DNS)](domain-name-service-dns.md), and [MySQL](install-and-configure-a-mysql-server.md).
...
Before installing Munin on `server01` Apache2 will need to be installed. The default configuration is fine for running a Munin server. For more information see [setting up Apache](../explanation/introduction-to-web-servers.md).
