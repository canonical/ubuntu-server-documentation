...
Since DPDK itself is only a (massive) library, you most likely will continue to [Open vSwitch DPDK](../how-to/how-to-use-dpdk-with-open-vswitch.md) as an example to put it to use.
