...
| | |
|--|--|
| [Tutorials](tutorial.md)</br> Get started - a hands-on introduction to Ubuntu Server for new users </br> | [How-to guides](how-to.md) </br> Step-by-step guides covering key operations and common tasks |
| [Explanation](explanation.md) </br> Concepts - discussion and clarification of key topics | [Reference](reference.md) </br> Technical information - package specifications, APIs, architecture | 
...
* Find out how to [contribute to the Server Guide](https://discourse.ubuntu.com/t/-/38717), or let us know your [feedback and suggestions](https://discourse.ubuntu.com/t/-/38718).
...
Ubuntu 18.04 LTS (Bionic Beaver): [PDF](https://assets.ubuntu.com/v1/8f8ea0cf-18-04-serverguide.pdf)
