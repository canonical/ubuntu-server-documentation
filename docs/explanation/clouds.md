...
For information related to public clouds in Ubuntu, you may also want to refer to the official [Public Cloud documentation](https://documentation.ubuntu.com/public-cloud/en/latest/).

For ease of reference, these links in the Public Cloud documentation will take you to the cloud images for:

* [Amazon EC2](https://canonical-aws.readthedocs-hosted.com/en/latest/aws-how-to/instances/find-ubuntu-images/) | [Google Compute Engine (GCE)](https://canonical-gcp.readthedocs-hosted.com/en/latest/google-how-to/gce/find-ubuntu-images/) | [Microsoft Azure](https://canonical-azure.readthedocs-hosted.com/en/latest/azure-how-to/instances/find-ubuntu-images/)
