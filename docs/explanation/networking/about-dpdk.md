...
## Resources
  ...
  - [Release Notes matching the version packages in Ubuntu 16.04](http://doc.dpdk.org/guides/rel_notes/release_2_2.html)

  - [Linux DPDK user getting started](http://doc.dpdk.org/guides/linux_gsg/index.html)

  - [EAL command-line options](http://doc.dpdk.org/guides/testpmd_app_ug/run_app.html)

  - [DPDK API documentation](http://doc.dpdk.org/api/)
