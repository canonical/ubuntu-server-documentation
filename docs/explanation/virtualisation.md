...
* {ref}`Introduction to virtualization <introduction-to-virtualization>` discusses and disambiguates between virtualization and containers
...
* {ref}`VM tools overview <vm-tools-in-the-ubuntu-space>` gives more details about the virtual machines available in Ubuntu
...
* {ref}`Container tools overview <container-tools-in-the-ubuntu-space>` gives more details about the popular container technologies available in Ubuntu
