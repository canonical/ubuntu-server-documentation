...
- For basics on how to assign VT-d devices to QEMU/KVM, please see the [linux-kvm](https://linux-kvm.org/page/Main_Pagepage/How_to_assign_devices_with_VT-d_in_KVM#Assigning_the_device) page.
